        ...
        <div id="body1" class="show" name="divcontent">
            <dl class="content">
                <dt>商户订单号
                    ：</dt>
                <dd>
                    <input id="" name="WIDout_trade_no" value="{{$rs->ordernumber}}"/>
                </dd>
                <hr class="one_line">
                <dt>商品名称
                    ：</dt>
                <dd>
                    <input  name="WIDsubject" value="{{$rs->pname}}" />
                </dd>
                <hr class="one_line">
                <dt>数量
                    ：</dt>
                <dd>
                    <input  name="WIDsubject" value="{{$rs->num}}" />
                </dd>
                <hr class="one_line">
                <dt>付款金额
                    ：</dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount" value="{{$rs->num*$rs->price}}" style="color: red" />
                </dd>
                <hr class="one_line">
                <dt>商品描述：</dt>
                <dd>
                    <input id="WIDbody" name="WIDbody" value="{{$rs->detail}}" />
                </dd>
                <hr class="one_line">
                <dt></dt>
                <dd id="btn-dd">
