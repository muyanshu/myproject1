...
<div class="panel panel-info">
    <div class="panel-heading ">
        ...
        <div class="crumb_warp">
            ...
            <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">产品类型管理</a> &raquo; 添加类型
        </div>
        <!--面包屑导航 结束-->
    </div>
            ...
            <li class="list-group-item parent">
                <div class="row ">
                    <div class="col-xs-1" style="padding: 0px 10px;">
                        <input name="id" class="selid" type="checkbox" value=""  >
                    </div>
                    <div class="col-xs-1" style=" padding: 0px;">
                        <input  name="order" class="form-control input-sm" type="text" value=""  />
                    </div>
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="#">添加子类</a></li>
                                <li><a href="#">修改</a></li>
                                <li><a class="delEvent" href="#" data-toggle="modal" id="id"
